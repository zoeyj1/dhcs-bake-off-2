...
class DragHandler {
    ...
    startDrag(ev) {
        ...
        if (this.el.dispatch('beforedrag', { event: ev, handler: this })
            .defaultPrevented) {
            return;
        }
        ...
        (0, SVG.on)(window, eventMove, this.drag, this, { passive: false });
        (0, SVG.on)(window, eventEnd, this.endDrag, this, { passive: false });
    ...
    drag(ev) {
        ...
        const x = box.x + dx;
        const y = box.y + dy;
        this.box = new SVG.Box(x, y, box.w, box.h);
    ...
    endDrag(ev) {
        ...
        // unbind events
        (0, SVG.off)(window, 'mousemove.drag');
        (0, SVG.off)(window, 'touchmove.drag');
        (0, SVG.off)(window, 'mouseup.drag');
        (0, SVG.off)(window, 'touchend.drag');
        // Rebind initial Events
        this.init(true);
    }
}
(0, SVG.extend)(SVG.Element, {
