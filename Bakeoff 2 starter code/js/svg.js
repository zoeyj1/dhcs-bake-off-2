...
var SVG = (function () {
    ...
    function dispatch(node, event, data, options) {
        ...
        if (event instanceof globals.window.Event) {
            ...
            event = new globals.window.CustomEvent(event, Object.assign({ detail: data, cancelable: true }, options));
            n.dispatchEvent(event);
        }
        return event;
    }
    ...
    class Element extends Dom {
        constructor(node, attrs) {
            ...
            if (node.hasAttribute('data-svgjs') || node.hasAttribute('svgjs:data')) {
                ...
                this.setData((_f = (_e = JSON.parse(node.getAttribute('data-svgjs'))) !== null && _e !== void 0 ? _e : JSON.parse(node.getAttribute('svgjs:data'))) !== null && _f !== void 0 ? _f : {});
            }
        }
    ...
    function transform(o, relative) {
        ...
        if (!Matrix.isMatrixLike(o)) {
            ...
            o = Object.assign(Object.assign({}, o), { origin: getOrigin(o, this) });
        }
    ...
    ***/
    ...
    extend(Runner, {
        ...
        transform(transforms, relative, affine) {
            ...
            function run(pos) {
                ...
                let target = new Matrix(Object.assign(Object.assign({}, transforms), { origin: [x, y] }));
            ...
            function retarget(newTransforms) {
                ...
                transforms = Object.assign(Object.assign({}, newTransforms), { origin });
            }
    ...
    class Text extends Shape {
        ...
        constructor(node, attrs = node) {
            ...
            this.dom.leading = (_e = this.dom.leading) !== null && _e !== void 0 ? _e : new SVGNumber(1.3); // store leading value for rebuilding
    ...
    class Style extends Element {
        ...
        font(name, src, params = {}) {
            return this.rule('@font-face', Object.assign({ fontFamily: name, src: src }, params));
        }
        rule(selector, obj) {
